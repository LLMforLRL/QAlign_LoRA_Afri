...
#SBATCH --output=outfile/finetuning-metamath_mgsm-%j.out
...
bash training_scripts/finetune_modified.sh MetaMath-Mistral-7B gsmtrans_gsm8kinstruct_question_all-en

# stage 2: response alignment
# finetuning stage 1 model with MetaMathQA dataset
bash training_scripts/finetune_modified.sh MetaMath-Mistral-7B.gsmtrans_gsm8kinstruct_question_all-en.finetune metamath_all

# EVALUATION MGSM
MODEL="MetaMath-Mistral-7B.gsmtrans_gsm8kinstruct_question_all-en.finetune.metamath_all.finetune"
