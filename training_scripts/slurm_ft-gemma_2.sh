...
#SBATCH --output=outfile/finetuning-gemma_2-%j.out
...
bash training_scripts/finetune_modified.sh gemma-2-9b-it gsm8kafri_all

# stage 2: response alignment
# finetuning stage 1 model with MetaMathQA dataset
bash training_scripts/finetune_modified.sh gemma-2-9b-it.gsm8kafri_all.finetune metamath_all
