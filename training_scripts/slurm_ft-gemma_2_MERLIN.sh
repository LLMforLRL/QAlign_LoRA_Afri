...
#SBATCH --output=outfile/finetuning-gemma_2_MERLIN-%j.out
...
#############################################################
# stage 1: mapping
# finetuning model on typical bilingual data
bash training_scripts/finetune_modified.sh gemma-2-9b-it african-bilingual-pairs_all
